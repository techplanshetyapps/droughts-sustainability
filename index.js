...
app.post('/api/droughts', async (req, res) => {
    ...
    try {
        ...
        const aiPrediction = ollamaResponse.data.response ? ollamaResponse.data.response.trim() : 'Analysis complete.';
        ...
        console.error('Prediction/Database error:', err.message);
